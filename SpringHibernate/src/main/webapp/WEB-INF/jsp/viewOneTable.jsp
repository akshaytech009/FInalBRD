...
<!-- 	<nav class="navbar navbar-inverse">
 ...
 Address1: ${customer.getCustomerAddress()}<br>	
 	
 PinCode: ${customer.getCustomerPincode()}<br>		
 e-mail Address: ${customer.getCustomerEmail()}<br>		
  Contact Number: ${customer.getContactNumber()}<br>
  Registration Date: ${customer.getRegistrationDate()}<br>
  CreatedBy: ${customer.getCreatedBy()}<br>
  ModifiedDate:${customer.getModifiedDate()}<br>		
  </form:form>
</body>
</html>